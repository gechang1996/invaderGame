...
namespace Testing
{
	TEST_CLASS(CInvaderOhioStateTest)
	{
	public:
		...
		TEST_METHOD(TestCInvaderHitTest)
		{
			...
			CGame game;
			CInvaderOhioState invader(&game);

			// Give it a location
			invader.SetLocation(200, 200);
			...
			// Above the invader
			Assert::IsTrue(invader.HitTest(200, 200));
